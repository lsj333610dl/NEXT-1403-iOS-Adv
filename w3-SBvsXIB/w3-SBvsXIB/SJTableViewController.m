...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        ...
        case 1:{
            SJCalendarViewController *calendarViewController = [SJCalendarViewController new];
            [self presentViewController:calendarViewController animated:NO completion:nil];
        }
